...
class VideoPlay extends StatefulWidget {
  ...
  VideoPlay( this.address,this.title,{Key key,}) : super(key: key);
...
*/
      ...
      body: Column(
        children: <Widget>[
          createTitle(context,widget.title,[Colors.purple,Colors.purple]),
          Flexible(
            child: WebView(
              ...
              Align(
                ...
                child: FlatButton(// text not true worked in aligen
                    ...
                    child: Directionality(
                      ...
                      child: Text(title.length<40 ? title:title.substring(0,40)+"...",
                          style:TextStyle(color: Colors.white,fontFamily: "BYekan",fontSize: 14)
                      ),
                    )
                ),
